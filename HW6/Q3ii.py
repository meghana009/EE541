...
#Plotting the Histogram of Weights for Hidden Layer with Dropout = 0.2 and Regularization = 0.0001

plt.hist(model[3].weight.detach().numpy().reshape(-1,1), bins = 100, color = 'skyblue', ec = 'black', lw =0.5)
plt.grid()
plt.xlabel('Magnitude of Weights')
plt.ylabel('Frequency')
